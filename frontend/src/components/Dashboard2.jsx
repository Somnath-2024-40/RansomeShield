...
const StatBox = ({ label, value }) => (
    <div className="bg-[#1e293b] text-white p-5 rounded-lg shadow-xl border-2 border-green-700 hover:border-[#00ff41] transition-all duration-300 transform hover:scale-[1.02]">
        <h3 className="text-sm opacity-80 mb-2 font-mono text-green-400">
            {label}
        </h3>
        <div className="text-5xl font-bold font-digital text-[#00ff41] tracking-wider">
         
            <span className="drop-shadow-[0_0_5px_rgba(0,255,65,0.7)]">
                {value}
            </span>
        </div>
    </div>
...
export default function RansomShieldDashboard() {
    ...
    const scanFile = async () => {
        ...
        try {
            ...
            message += `  - Threat: ${
                result.entropy_scan.threat ? "⚠️ YES" : "✅ NO"
            }\n`;
            message += `  - Reason: ${result.entropy_scan.reason}\n`;
            message += `  - Risk Level: ${result.entropy_scan.risk}\n`;
            message += `  - Score: ${(result.entropy_scan.score * 100).toFixed(
                1
            )}%\n`;
            ...
            <div className="max-w-[1400px] mx-auto bg-transparent border-2 border-green-800 rounded-xl px-8 shadow-2xl shadow-green-900/50">
                ...
                <div className="text-center mb-10 pb-5 border-b-2 border-green-700">
                    <h1 className="vt323-regular text-xl  lg:text-5xl backdrop-blur-4xl font-extrabold text-[#00ff41] mb-2 flex items-center justify-center gap-4 drop-shadow-[0_0_8px_rgba(0,255,65,0.7)]">
                        <span className="pt-1 text-xl lg:text-4xl backdrop-blur-4xl ">
                            🛡️
                        </span>{" "}
                        RansomShield Pro
                    </h1>
                    <p className="text-green-500 text-lg font-mono tracking-wide">
                    ...
                    <div
                        className={`inline-block px-5 py-2 rounded-full font-bold mt-3 border ${
                            systemActive
                ...
                <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-10">
                    ...
                    <StatBox
                        ...
                        value={stats.backups_created}
                    />
                    <StatBox
                        label="Honeypots Active"
                        value={stats.honeypots_active}
                    />
                    <StatBox
                        label="Processes Killed"
                        value={stats.processes_killed}
                    />
                </div>
                ...
                <div className="bg-gray-800/80 p-6 rounded-lg mb-10 border border-green-900 shadow-inner shadow-green-900">
                    ...
                    <div className="flex flex-wrap gap-4 mb-4">
                        ...
                        <button
                            ...
                            className={`px-6 py-3 rounded-lg font-bold transition-all duration-200 shadow-md ${
                                systemActive
                                    ? "bg-gray-600 text-gray-400 cursor-not-allowed opacity-50"
                                    : "bg-green-700 text-white hover:bg-green-600 hover:scale-[1.05] shadow-green-700/50"
                            }`}>
                            Start Protection
                        </button>
                        <button
                    ...
                    <div className="flex flex-wrap gap-4 pt-2">
                        <button
                            ...
                            className="px-6 py-3 bg-gray-700 text-green-400 rounded-lg font-bold hover:bg-gray-600 hover:text-[#00ff41] transition-colors border border-green-900">
                            Generate Report
                        </button>
                        <button
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 bg-gray-800/80 rounded-lg p-6 shadow-xl border border-green-900">
                        ...
                        <div className="max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                            ...
                            {loading ? (
                                <div className="text-center py-10 text-green-700 animate-pulse font-mono">
                                    Loading data matrix...
                                </div>
                            ) : threats.length === 0 ? (
                                ...
                                threats.map((threat, i) => (
                                    <div
                                        key={`${threat.file}-${i}`}
                                        className={`p-4 mb-3 rounded-md border-l-4 font-mono transition-transform duration-100 hover:bg-gray-700 ${
                                            threat.risk === "CRITICAL"
                    ...
                    <div className="bg-gray-800/80 rounded-lg p-6 shadow-xl border border-green-900">
                        ...
                        <canvas
                            ref={canvasRef}
                            className="w-full h-[300px] bg-gray-900 rounded-lg border border-green-800"></canvas>
                        <div className="mt-5 text-sm text-gray-400 space-y-1 font-mono">
                            <p>
                                <strong>DETECTION_ENGINE:</strong>{" "}
                                <span className="text-green-400">
                                    ACTIVE_ONLINE
                                </span>
                            </p>
                            <p>
                                <strong>BACKUP_SIZE:</strong>{" "}
                                {stats.backup_size_mb.toFixed(2)} MB
                            </p>
                            <p>
